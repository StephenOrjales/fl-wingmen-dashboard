...
with st.sidebar:
    ...
    nav_options = ["KDS Dashboard", "Schedule Guide", "Internal QSC Evals", "COGS Variance", "Sales Performance", "Labor Dashboard", "SMG (Guest Satisfaction)", "District Comparison", "Scorecard", "Watch List", "Trends", "Wing Worm"]
